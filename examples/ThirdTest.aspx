<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThirdTest.aspx.cs" Inherits="TestCalendarControl.ThirdTest" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table>
                ...
                <tr>
                    <td colspan="4">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="lblDayOfWeek" runat="server" Text="Day Of Week" />
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="lblWeekOfMonth" runat="server" Text="Week Of Month" />
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="lblMonthInterval" runat="server" Text="Month Interval" />
                                </td>
                                <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblDayInterval" runat="server" Text="Day Interval" />
                    </td>
